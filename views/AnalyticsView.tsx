...
import type { Release, AnalyticsData, Song, TopCountry } from '../types';
                     ...
                     <div className="space-y-4">
                         <div className="flex justify-between items-center">
                             <div className="flex items-center gap-3">
                                 ...
                                 <div>
                                     <p className="font-bold text-white">Spotify Editorial</p>
                                     <p className="text-xs text-ui-text-subtle">2 Playlists</p>
                                 </div>
                             </div>
                             <p className="font-mono text-white">1.2M Reach</p>
                         </div>
                         <div className="flex justify-between items-center">
                             <div className="flex items-center gap-3">
                                 <div className="w-10 h-10 bg-gray-500 rounded-md"></div>
                                 <div>
                                     <p className="font-bold text-white">User Curated</p>
                                     <p className="text-xs text-ui-text-subtle">145 Playlists</p>
                                 </div>
                             </div>
                             <p className="font-mono text-white">450K Reach</p>
                         </div>
                     </div>
                </div>
            </div>
...
const OverviewTab: React.FC<{data: AnalyticsData}> = ({ data }) => {
    ...
    const handleGenerateInsights = async () => {
        ...
        const insights = await generateAnalyticsInsights(data, language);
