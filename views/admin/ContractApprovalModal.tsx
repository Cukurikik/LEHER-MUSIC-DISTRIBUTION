            ...
            >
                ...
                <div className="p-6 md:p-8 space-y-6">
                    ...
                    <div className="flex justify-end gap-4 pt-4 border-t border-ui-border">
                        ...
                        <button type="button" onClick={handleApprove} className="px-6 py-2 rounded-full bg-primary text-black font-bold transition shadow-lg hover:brightness-110 btn-glow-primary">Approve Contract</button>
                    </div>
                </div>
            </div>
        </div>
