        ...
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div className="bg-ui-surface p-6 rounded-2xl border border-ui-border space-y-4">
                    <h2 className="text-xl font-bold">Pilih Gaya Animasi</h2>
                    <div className="grid grid-cols-2 gap-2">
                     ...
                     <button className="w-full mt-4 btn-glow-primary py-2.5 rounded-full font-semibold">Ekspor sebagai MP4</button>
                </div>
